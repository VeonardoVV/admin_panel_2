...
const Seccion_1 = () => {
  ...
  const [productoEditandoId, setProductoEditandoId] = useState<number | null>(null); // 👈 agregado
  ...
  return (
    <div className={styles.seccion}>
      ...
      {/* Modal encima si hay un id seleccionado */}
      {productoEditandoId !== null && (
        <Archivo
          id={productoEditandoId}
          onCerrar={() => setProductoEditandoId(null)}
          onGuardado={() => { setProductoEditandoId(null); obtenerProductos(); }}
        />
      )}
              ...
              <td>
                <div className={styles.EditarEliminar}>
                  ...
                  <svg
                    ...
                    onClick={() => setProductoEditandoId(p.id_producto)} // 👈
                  ...
                  <svg
                    ...
                    viewBox="0 0 24 24"
                  >
                    <path d="M6 7h12v14H6zM9 3h6l1 2H8l1-2zm1 6h2v10h-2V9zm4 0h2v10h-2V9z" />
                  </svg>
                </div>
              </td>
            </tr>
